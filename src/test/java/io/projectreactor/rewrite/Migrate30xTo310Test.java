...
public class Migrate30xTo310Test {
    ...
    public void migrateMonoThenAndFlatmap() throws Exception {
        ...
        String refactored = Migrate30xTo310.migrateMonoThenAndFlatmap(a.refactor()).print();
    ...
    public void migrateFluxSwitchOnError() throws Exception {
        ...
        String refactored = Migrate30xTo310.migrateErrorHandlingOperators(a.refactor()).print();
